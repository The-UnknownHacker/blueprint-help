...
app.event('message', async ({ event, client, logger }) => {
    ...
    await client.chat.postMessage({
        ...
        thread_ts: event.ts,
        text: `:hyper-dino-wave: Thank you for creating a ticket someone will help you soon. make sure to read the not finished yet and the "not finished yet either i know we slacking before asking questions" section!`
    })
});
